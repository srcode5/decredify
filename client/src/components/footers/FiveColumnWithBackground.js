...
const Link = tw.a`border-b-2 border-transparent text-gray-100 hocus:border-gray-100 pb-1 transition duration-300`;
  ...
  return (
    <Container>
      <Content>
        ...
        <ThreeColRow>
          <LogoContainer>
            <LogoText>Decredify</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2022 Decredify. All Rights Reserved.</CopywrightNotice>
