...
`;
/**
 * Purpose: Basic Terms of Service for our startup's web application so that we have legal boundaries established beforehand.
 */
        ...
        <ContentWithPaddingXl>
          ...
          <Text>
            ...
            <ul>
              ...
              <li>
                <strong>Website</strong> refers to Decredify.
              </li>
              <li>
            ...
            <ul>
              <li>By email: Decredify@gmail.com</li>
              <li>By phone number: 925.786.8762</li>
            </ul>
          </Text>
        </ContentWithPaddingXl>
      </Container>
